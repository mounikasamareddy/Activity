    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        deleteTextView.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AlertDialog.Builder alertDialog = new AlertDialog.Builder(AddMaterial.this);
        ...
        addImageLayout.setOnClickListener(new OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                singleton.setSelectedMaterialQty(qtyEditText.getText().toString().trim());
                ...
                AlertDialog alertDialog = new AlertDialog.Builder(AddMaterial.this).create();
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            convertView.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    //singleton.setSelectedMaterialDescription(descEditText.getText().toString().trim());
                    if (val[0].equals("Name")) {
                        Intent intent = new Intent(AddMaterial.this, MaterialNameList.class);
                        overridePendingTransition(0, 0);
                        startActivity(intent);
                    } else if (val[0].equals("Company")) {
                        Intent intent = new Intent(AddMaterial.this, MaterialCompanyList.class);
                        overridePendingTransition(0, 0);
                        startActivity(intent);
                    } else if (val[0].equals("Status")){
                        Intent intent = new Intent(AddMaterial.this, MaterialStatusList.class);
                        overridePendingTransition(0, 0);
                        startActivity(intent);
                    }
                }
    ...
    private class AddMaterialEntries extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... arg0) {
            ...
            try{
                ...
                try {
                    ...
                    jsonAddMaterialJSON.put("AccountID", singleton.getAccountId());
                    jsonAddMaterialJSON.put("SubscriberID", singleton.getSubscriberId());
                    jsonAddMaterialJSON.put("ProjectID", singleton.getSelectedProjectID());
                    jsonAddMaterialJSON.put("ActivityId", singleton.getSelectedActivityID());
                    jsonAddMaterialJSON.put("ProjectDay", singleton.getCurrentSelectedDate());
                    jsonAddMaterialJSON.put("Name", singleton.getSelectedMaterialName());
                    jsonAddMaterialJSON.put("Company", singleton.getSelectedMaterialCompany());
                    jsonAddMaterialJSON.put("Status", singleton.getSelectedMaterialStatus());
                    jsonAddMaterialJSON.put("Quantity", singleton.getSelectedMaterialQty());
                    //jsonaddPersionnel.put("Notes", singleton.getSelectedMaterialDescription());
                    jsonAddMaterialJSON.put("TaskId", singleton.getSelectedMaterialDescription());
        ...
        protected void onPostExecute(final String result) {
            ...
            if (ServerUtilities.unknownHostException) {
                ...
                materialInsertResponse = dbAdapter.insertEntry(singleton.getSelectedMaterialName(), singleton.getSelectedMaterialCompany(), singleton.getSelectedMaterialStatus(), singleton.getSelectedMaterialQty(), "M", "I", dbAdapter.generateOfflineEntryID());
            } else {
                if(result != null) {
                    ...
                    try {
                        ...
                        if(StatusCode == 200 || StatusCode == 0){
                            materialInsertResponse = dbAdapter.insertEntry(singleton.getSelectedMaterialName(), singleton.getSelectedMaterialCompany(), singleton.getSelectedMaterialStatus(), singleton.getSelectedMaterialQty(), "M", "N", jObject.getString("MID"));
                            System.out.println("materialInsertResponse inside Add Labor Success: " + materialInsertResponse);
                            /*singleton.setReloadPage(true);
                            Intent intent = new Intent(AddMaterial.this, EntriesListActivity.class);
                            intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                            startActivity(intent);
                            finish();*/
                        }else{
                            materialInsertResponse = dbAdapter.insertEntry(singleton.getSelectedMaterialName(), singleton.getSelectedMaterialCompany(), singleton.getSelectedMaterialStatus(), singleton.getSelectedMaterialQty(), "M", "I", dbAdapter.generateOfflineEntryID());
                            System.out.println("materialInsertResponse inside Add Labor Failure: " + materialInsertResponse);
                            singleton.setReloadPage(true);
                        }
                    } catch (JSONException e) {
                        e.printStackTrace();
        ...
        protected String doInBackground(Void... arg0) {
            ...
            try{
                ...
                try {
                    ...
                    jsonAddMaterialJSON.put("Quantity", singleton.getSelectedMaterialQty());
                    //jsonaddPersionnel.put("Notes", singleton.getSelectedMaterialDescription());
                    //jsonaddPersionnel.put("ProjectDay", singleton.getCurrentSelectedDate());
                    jsonAddMaterialJSON.put("ID", singleton.getCurrentSelectedEntryID());
                    //jsonaddPersionnel.put("UserId", singleton.getUserId());
                    System.out.println("equipment id.............."+singleton.getCurrentSelectedEntryID());

                    return jsonDataPost.updateMaterialEntry(jsonAddMaterialJSON);
        ...
        protected void onPostExecute(final String result) {
            ...
            if (ServerUtilities.unknownHostException) {
                ...
                if(singleton.isOfflineEntry())
                    materialUpdateResponse = dbAdapter.updateEntry(singleton.getSelectedMaterialName(), singleton.getSelectedMaterialCompany(), singleton.getSelectedMaterialStatus(), singleton.getSelectedMaterialQty(), "M", "I", "OF"+String.valueOf(singleton.getCurrentSelectedEntryID()));
                else
                    materialUpdateResponse = dbAdapter.updateEntry(singleton.getSelectedMaterialName(), singleton.getSelectedMaterialCompany(), singleton.getSelectedMaterialStatus(), singleton.getSelectedMaterialQty(), "M", "U", String.valueOf(singleton.getCurrentSelectedEntryID()));
            } else {
                if(result != null){
                    System.out.println("Update material response: " + result);
                    int StatusCode = singleton.getHTTPResponseStatusCode();
                    if(StatusCode == 200 || StatusCode == 0){
                        materialUpdateResponse = dbAdapter.updateEntry(singleton.getSelectedMaterialName(), singleton.getSelectedMaterialCompany(), singleton.getSelectedMaterialStatus(), singleton.getSelectedMaterialQty(), "M", "N", String.valueOf(singleton.getCurrentSelectedEntryID()));
                    }else{
                        if(singleton.isOfflineEntry())
                            materialUpdateResponse = dbAdapter.updateEntry(singleton.getSelectedMaterialName(), singleton.getSelectedMaterialCompany(), singleton.getSelectedMaterialStatus(), singleton.getSelectedMaterialQty(), "M", "I", "OF"+String.valueOf(singleton.getCurrentSelectedEntryID()));
                        else
    ...
    private class DeleteMaterialTask extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... arg0) {
            ...
            try{
                ...
                try {
                    ...
                    jsonAddMaterial.put("Id", singleton.getCurrentSelectedEntryID());
        ...
        protected void onPostExecute(final String result) {
            ...
            if (ServerUtilities.unknownHostException) {
                ...
                Toast.makeText(getApplicationContext(), "Sorry! Server could not be reached.", Toast.LENGTH_LONG).show();
                if(singleton.isOfflineEntry())
                    materialDeleteResponse = dbAdapter.deleteEntryByID("OF" + String.valueOf(singleton.getCurrentSelectedEntryID()));
                else
                    materialDeleteResponse = dbAdapter.updateEntry(singleton.getSelectedMaterialName(), singleton.getSelectedMaterialCompany(), singleton.getSelectedMaterialStatus(), singleton.getSelectedMaterialQty(), "M", "D", String.valueOf(singleton.getCurrentSelectedEntryID()));
            } else {
                if (result != null) {
                    System.out.println("Update material response: " + result);
                    int StatusCode = singleton.getHTTPResponseStatusCode();
